...
var InputHidden = function (props) {
    ...
    return (jsx(React.Fragment, { children: jsx("input", { "aria-label": "fui-hidden-input", style: { display: "none" }, ref: inputRef, onChange: onChange, type: "file", accept: accept, multiple: multiple }) }));
};
...
var DropzoneChildren = function (props) {
    ...
    if (children && !isEmptyArray) {
        return (jsx("div", __assign$1({ className: "files-ui-dropzone-children-container" }, { children: children })));
    }
    else
        return (jsx("div", __assign$1({ className: "files-ui-dropzone-children-container" }, { children: jsxs("label", { children: [" ", label || DropzoneLocalizer.defaultLabel] }) })));
};
...
var DropzoneDisabledLayer = function (props) {
    ...
    if (open) {
        return (jsx("div", { style: style, className: finalDisabledLayerClassName, onDrop: handleDrop, onDragOver: handleDrag, onClick: handleClick }));
    }
    else {
        return jsx(Fragment, {});
    }
...
var Cancel = function (props) {
    ...
    return (jsxs("svg", __assign$1({ style: onClick ? __assign$1({}, __assign$1({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function (e) {
            handleClickUtil(e);
            onClick === null || onClick === void 0 ? void 0 : onClick(e);
        }, xmlns: "http://www.w3.org/2000/svg", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color ? color : "#000000", className: className || "" }, { children: [jsx("path", { d: "M0 0h24v24H0V0z", fill: "none", opacity: ".87" }), jsx("path", { d: "M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8 8-3.59 8-8-3.59-8-8-8zm5 11.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z", fill: colorFill ? colorFill : "none", opacity: ".5" }), jsx("path", { d: "M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm3.59-13L12 10.59 8.41 7 7 8.41 10.59 12 7 15.59 8.41 17 12 13.41 15.59 17 17 15.59 13.41 12 17 8.41z" })] })));
};
...
var CheckCircle = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (jsxs("svg", __assign$1({ className: className || "", style: onClick ? __assign$1({}, __assign$1({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color ? color : "#000000" }, { children: [jsx("path", { d: "M0 0h24v24H0z", fill: colorFill ? colorFill : "none" }), jsx("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" })] })));
};
...
var Clean = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (jsxs("svg", __assign$1({ className: className || "", style: onClick ? __assign$1({}, __assign$1({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", enableBackground: "new 0 0 24 24", height: finalSize ? "".concat(finalSize, "px") : "24px", viewBox: "0 0 24 24", width: finalSize ? "".concat(finalSize, "px") : "24px", fill: color ? color : "#000000" }, { children: [jsx("g", { children: jsx("rect", { fill: "none", height: finalSize || "24", width: finalSize || "24" }) }), jsx("g", { children: jsx("g", { children: jsx("path", { d: "M16,11h-1V3c0-1.1-0.9-2-2-2h-2C9.9,1,9,1.9,9,3v8H8c-2.76,0-5,2.24-5,5v7h18v-7C21,13.24,18.76,11,16,11z M11,3h2v8h-2V3 z M19,21h-2v-3c0-0.55-0.45-1-1-1s-1,0.45-1,1v3h-2v-3c0-0.55-0.45-1-1-1s-1,0.45-1,1v3H9v-3c0-0.55-0.45-1-1-1s-1,0.45-1,1v3H5 v-5c0-1.65,1.35-3,3-3h8c1.65,0,3,1.35,3,3V21z" }) }) })] })));
};
...
var Clear = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (jsxs("svg", __assign$1({ className: className || "", style: onClick ? __assign$1({ cursor: "pointer" }, finalStyle) : finalStyle, xmlns: "http://www.w3.org/2000/svg", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color ? color : "#000000", onClick: function (e) {
            handleClickUtil(e);
            onClick === null || onClick === void 0 ? void 0 : onClick(e);
        } }, { children: [jsx("path", { d: "M0 0h24v24H0V0z", fill: colorFill || "none" }), jsx("path", { d: "M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41z" })] })));
};
...
var CloudDone = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (jsxs("svg", __assign$1({ className: className || "", style: onClick ? __assign$1({ cursor: "pointer" }, finalStyle) : finalStyle, enableBackground: "new 0 0 24 24", xmlns: "http://www.w3.org/2000/svg", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color || "#000000", onClick: function (e) {
            handleClickUtil(e);
            onClick === null || onClick === void 0 ? void 0 : onClick(e);
        } }, { children: [jsx("path", { d: "M0 0h24v24H0V0z", fill: colorFill || "none" }), jsx("path", { d: "M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM19 18H6c-2.21 0-4-1.79-4-4 0-2.05 1.53-3.76 3.56-3.97l1.07-.11.5-.95C8.08 7.14 9.94 6 12 6c2.62 0 4.88 1.86 5.39 4.43l.3 1.5 1.53.11c1.56.1 2.78 1.41 2.78 2.96 0 1.65-1.35 3-3 3zm-9-3.82l-2.09-2.09L6.5 13.5 10 17l6.01-6.01-1.41-1.41z" })] })));
};
...
var DoDisturb = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (jsxs("svg", __assign$1({ className: className || "", style: onClick ? __assign$1({}, __assign$1({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", height: finalSize ? "".concat(finalSize, "px") : "24px", viewBox: "0 0 24 24", width: finalSize ? "".concat(finalSize, "px") : "24px", fill: color ? color : "#000000" }, { children: [jsx("path", { d: "M0 0h24v24H0V0z", fill: "none" }), jsx("path", { d: "M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8 8-3.59 8-8-3.59-8-8-8z", opacity: ".4" }), jsx("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8 0-1.85.63-3.55 1.69-4.9L16.9 18.31C15.55 19.37 13.85 20 12 20zm6.31-3.1L7.1 5.69C8.45 4.63 10.15 4 12 4c4.42 0 8 3.58 8 8 0 1.85-.63 3.55-1.69 4.9z" })] })));
};
...
var DownloadFile = function (props) {
    ...
    return (jsxs("svg", __assign$1({ className: className || "", style: onClick ? __assign$1({ cursor: "pointer" }, finalStyle) : finalStyle, enableBackground: "new 0 0 24 24", xmlns: "http://www.w3.org/2000/svg", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color || "#000000", onClick: function (e) {
            handleClickUtil(e);
            onClick === null || onClick === void 0 ? void 0 : onClick(e);
        } }, { children: [jsx("g", { children: jsx("rect", { fill: colorFill || "none", height: finalSize, width: finalSize }) }), jsx("g", { children: jsx("path", { d: "M18,15v3H6v-3H4v3c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2v-3H18z M17,11l-1.41-1.41L13,12.17V4h-2v8.17L8.41,9.59L7,11l5,5 L17,11z" }) })] })));
};
...
var PlayIcon = function (props) {
    ...
    return (jsxs("svg", __assign$1({ className: className || "", style: onClick ? __assign$1({ cursor: "pointer" }, finalStyle) : finalStyle, xmlns: "http://www.w3.org/2000/svg", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color ? color : "#000000", onClick: function (e) {
            handleClickUtil(e);
            onClick === null || onClick === void 0 ? void 0 : onClick(e);
        } }, { children: [jsx("path", { d: "M0 0h24v24H0V0z", opacity: ".9", fill: colorFill ? colorFill : "none" }), jsx("path", { d: "M8 5v14l11-7L8 5z" })] })));
};
...
var Upload = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (jsxs("svg", __assign$1({ style: onClick ? __assign$1({}, __assign$1({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", enableBackground: "new 0 0 24 24", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color ? color : "#000000", className: className || "" }, { children: [jsx("g", { children: jsx("rect", { fill: colorFill || "none", height: size || "24", width: size || "24" }) }), jsx("g", { children: jsx("path", { d: "M18,15v3H6v-3H4v3c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2v-3H18z M7,9l1.41,1.41L11,7.83V16h2V7.83l2.59,2.58L17,9l-5-5L7,9z" }) })] })));
};
...
var UploadError = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (jsxs("svg", __assign$1({ className: className || "", style: onClick ? __assign$1({}, __assign$1({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color ? color : "#000000" }, { children: [jsx("rect", { fill: colorFill ? colorFill : "none", height: finalSize, width: finalSize }), jsx("path", { d: "M18,15.17V15h2v2.17L18,15.17z M15.41,12.59L17,11l-1.41-1.41L14,11.17L15.41,12.59z M13,10.17V4h-2v4.17L13,10.17z M21.19,21.19l-1.78-1.78L2.81,2.81L1.39,4.22l6.19,6.19L7,11l5,5l0.59-0.59L15.17,18H6v-3H4v3c0,1.1,0.9,2,2,2h11.17l2.61,2.61 L21.19,21.19z" })] })));
};
...
var UploadingProcess = function (props) {
    ...
    return (jsxs("svg", __assign$1({ className: finalClassname, style: onClick ? __assign$1({}, __assign$1({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", height: finalSize ? "".concat(finalSize, "px") : "24px", viewBox: "0 0 24 24", width: finalSize ? "".concat(finalSize, "px") : "24px", fill: color ? color : "#000000" }, { children: [jsx("path", { d: "M0 0h24v24H0V0z", fill: "none" }), jsx("path", { d: "M12 4V1L8 5l4 4V6c3.31 0 6 2.69 6 6 0 1.01-.25 1.97-.7 2.8l1.46 1.46C19.54 15.03 20 13.57 20 12c0-4.42-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6 0-1.01.25-1.97.7-2.8L5.24 7.74C4.46 8.97 4 10.43 4 12c0 4.42 3.58 8 8 8v3l4-4-4-4v3z" })] })));
};
...
var Visibility = function (props) {
    ...
    return (jsxs("svg", __assign$1({ className: className || "", style: onClick ? __assign$1({ cursor: "pointer" }, finalStyle) : finalStyle, xmlns: "http://www.w3.org/2000/svg", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color ? color : "#000000", onClick: function (e) {
            handleClickUtil(e);
            onClick === null || onClick === void 0 ? void 0 : onClick(e);
        } }, { children: [jsx("path", { d: "M0 0h24v24H0V0z", fill: "none" }), jsx("path", { d: "M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8 8-3.59 8-8-3.59-8-8-8z", 
                //opacity=".9"
                fill: colorFill ? colorFill : "none" }), jsx("path", { d: "M12 4C7 4 2.73 7.11 1 11.5 2.73 15.89 7 19 12 19s9.27-3.11 11-7.5C21.27 7.11 17 4 12 4zm0 12.5c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z" })] })));
};
...
var DropzoneHeader = function (props) {
    ...
    var makeHeader = function () {
        ...
        if (onUploadStart && urlPresent && numberOfValidFiles) {
            if (isUploading) {
                result.push(jsx(UploadingProcess, { spin: true, color: color }));
            }
            else {
                result.push(jsxs(React.Fragment, { children: [jsx(Fragment, { children: DropzoneHeaderLocalizer.uploadFilesMessage }), jsx(Upload, { color: color, onClick: handleStartUploading })] }));
            }
            result.push(jsxs(React.Fragment, { children: [",", "\u00A0"] }));
        }
        ...
        if (onClean) {
            result.push(jsx(Clean, { color: color, onClick: handleClean, size: "semi-medium" }));
        }
        if (onReset) {
            result.push(jsx(Cancel, { color: color, onClick: function () { return onReset === null || onReset === void 0 ? void 0 : onReset(); } }));
        }
        return result;
    };
    function handleClick(evt) {
    ...
    return (jsx("div", __assign$1({ className: finalClassName, onClick: handleClick, style: finalStyle }, { children: makeHeader().map(function (HeaderItem, index) { return (jsx("span", __assign$1({ style: { display: "flex" } }, { children: HeaderItem }), index)); }) })));
};
...
var DropzoneFooter = function (props) {
    ...
    return (jsx("div", __assign$1({ className: finalClassName, onClick: handleClick, style: finalStyle }, { children: customMessage ? (jsx(Fragment, { children: customMessage })) : (jsx(Fragment, { children: message
                ? message
                : !accept
                    ? allowedTypesLabel
...
var MaterialButton = function (props) {
    ...
    if (finalMBClassNameDarkMode !== undefined || resetStyles)
        return React.createElement(href ? "a" : "button", __assign$1({ className: resetStyles && className ? className : finalMBClassNameDarkMode, "data-testid": href ? "dui-anchor" : "dui-button", onClick: handleClick, href: href, style: style, children: jsx("span", __assign$1({ className: "material-button-label" }, { children: children })), disabled: disabled }, rest));
    else
        return jsx(React.Fragment, { children: "loading styes" });
};
...
var DropzoneButtons = function (props) {
    ...
    return (jsx("div", __assign$1({ className: finalClassName, style: containerStyle }, { children: actionButtonsList.map(function (actionButtonProps, index) {
            ...
            return (jsx(MaterialButton, __assign$1({ className: className, style: style, resetStyles: resetStyles, onClick: function (evt) { return onClick === null || onClick === void 0 ? void 0 : onClick(evt); }, disabled: disabled }, { children: children || label }), index));
        }) })));
};
...
var DropLayer = function (props) {
    ...
    return (jsx("div", { className: classNameLayer, onDragLeave: onDragLeave, onDrop: onDrop, 
        //onDragEnd={onDragEnd}
...
var Dropzone = function (props) {
    ...
    if (!finalDropzoneClassNameBorderClickable)
        return jsx(Fragment, {});
    return (jsxs(React.Fragment, { children: [actionButtonsPosition === "before" && (jsx(DropzoneButtons, { disabled: disabled, abortButton: isUploading ? abortButton : undefined, onAbort: handleAbortUpload, deleteButton: deleteButton, onDelete: !isUploading ? handleReset : undefined, uploadButton: !isUploading && !autoUpload ? uploadButton : undefined, onUpload: !autoUpload ? function () { return uploadfiles(localFiles); } : undefined, cleanButton: validateFilesFlag && !isUploading && !autoClean
                    ? cleanButton
                    : undefined, onClean: handleClean, style: containerStyle, className: containerClassName, top: true })), jsxs("div", __assign$1({ style: style, className: finalDropzoneClassNameBorderClickable }, rest, { onClick: handleClick, onDragOver: handleDragEnter, onDragLeave: !dropOnLayer ? handleDragLeave : undefined, onDrop: !dropOnLayer ? kamui : undefined }, { children: [!disableRipple && (jsx("div", __assign$1({ ref: fuiRippleRefAbs, className: "filesui-base-ripple-absolute", style: { borderRadius: style === null || style === void 0 ? void 0 : style.borderRadius } }, { children: jsx("div", { ref: fuiRippleRefRel, className: "filesui-base-ripple-relative" }) }))), jsx(React.Fragment, { children: header ? (jsx(Fragment, { children: customHeader ? (jsx(Fragment, { children: customHeader })) : (jsx(DropzoneHeader, { firstClassName: headerClassName, color: completeAsureColor(color), style: styleHeader, className: classNameHeader, resetStyles: resetStylesHeader, borderRadius: styleBorderRadius, isUploading: isUploading && uploadingIconHedaer, onReset: !isUploading && deleteFilesHeader ? handleReset : undefined, maxFileSize: maxFileSize && maxFileSizeHeader ? maxFileSize : undefined, maxFiles: maxFiles && validFilesCountHeader ? maxFiles : undefined, localization: localization, urlPresent: shouldUpload && uploadFilesHeader, onUploadStart: !autoUpload && !uploadButton
                                ...
                                onClean: !cleanFilesHeader || isUploading || cleanButton || autoClean
                                    ...
                                    : (cleanFiles || onClean) && validateFilesFlag
                                        ? handleClean
                                        : undefined })) })) : (jsx(Fragment, {})) }), jsx(DropzoneChildren, __assign$1({ label: label, localization: localization }, { children: children })), jsx(React.Fragment, { children: customFooter ? (jsx(Fragment, { children: customFooter })) : (jsx(Fragment, { children: footer && (jsx(DropzoneFooter, __assign$1({ firstClassName: footerClassName, borderRadius: styleBorderRadius, accept: accept, message: isUploading ? localMessage : undefined, localization: localization }, footerConfig))) })) }), dropOnLayer && (jsx(DropLayer, { open: isDragging, className: !isDragging
                            ? dropLayerClassName
                            : "".concat(dropLayerClassName, " dropzone-layer-drag"), onDragLeave: handleDragLeave, onDrop: kamui, style: { borderRadius: style === null || style === void 0 ? void 0 : style.borderRadius } })), jsx(InputHidden, { multiple: maxFiles ? maxFiles > 1 : true, accept: accept || "", inputRef: inputRef, onChange: handleChangeInput }), jsx(DropzoneDisabledLayer, { open: disabled, className: disabledLayerClassName })] })), actionButtonsPosition === "after" && (jsx(DropzoneButtons, { disabled: disabled, abortButton: isUploading ? abortButton : undefined, onAbort: handleAbortUpload, deleteButton: deleteButton, onDelete: !isUploading ? handleReset : undefined, uploadButton: !isUploading && !autoUpload ? uploadButton : undefined, onUpload: !autoUpload ? function () { return uploadfiles(localFiles); } : undefined, cleanButton: validateFilesFlag && !isUploading && !autoClean
                    ? cleanButton
...
var FileInputButton = function (props) {
    ...
    return (jsxs(React.Fragment, { children: [actionButtonsPosition === "before" && (jsx(DropzoneButtons, { disabled: disabled, abortButton: isUploading ? abortButton : undefined, onAbort: handleAbortUpload, deleteButton: deleteButton, onDelete: !isUploading ? handleReset : undefined, uploadButton: !isUploading && !autoUpload ? uploadButton : undefined, onUpload: !autoUpload ? function () { return uploadfiles(localFiles); } : undefined, cleanButton: validateFilesFlag && !isUploading && !autoClean
                    ? cleanButton
                    : undefined, onClean: handleClean, style: containerStyle, className: containerClassName, top: true })), jsx(MaterialButton, __assign$1({ disabled: disabled, className: className, style: style, color: color, variant: variant, textTransform: textTransform, textColor: textColor, resetStyles: resetStyles, onClick: handleClick, disableRipple: disableRipple, darkMode: darkMode, id: inputButtonId }, rest, { children: children || label })), jsx(InputHidden, { multiple: maxFiles ? maxFiles > 1 : true, accept: accept || "", inputRef: inputRef, onChange: handleChangeInput }), actionButtonsPosition === "after" && (jsx(DropzoneButtons, { disabled: disabled, abortButton: isUploading ? abortButton : undefined, onAbort: handleAbortUpload, deleteButton: deleteButton, onDelete: !isUploading ? handleReset : undefined, uploadButton: !isUploading && !autoUpload ? uploadButton : undefined, onUpload: !autoUpload ? function () { return uploadfiles(localFiles); } : undefined, cleanButton: validateFilesFlag && !isUploading && !autoClean
                    ? cleanButton
                    : undefined, onClean: handleClean, style: containerStyle, className: containerClassName, top: false }))] }));
};
...
var BasePreparingLoader = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (jsx("svg", __assign$1({ xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", width: "".concat(finalSize, "px"), height: "".concat(finalSize, "px"), style: finalStyle, viewBox: "0 0 100 100", preserveAspectRatio: "xMidYMid" }, { children: jsx("circle", __assign$1({ cx: "".concat(finalX), cy: "".concat(finalY), r: "".concat(finalRadius), fill: "none", stroke: color || "#14ff00", strokeWidth: "".concat(width || 8, "px"), strokeDasharray: "164.93361431346415 100.97787143782138" }, { children: jsx("animateTransform", { attributeName: "transform", type: "rotate", repeatCount: "indefinite", dur: "1s", values: "0 ".concat(finalX, " ").concat(finalX, ";360 ").concat(finalX, " ").concat(finalX), keyTimes: "0;1" }) })) })));
};
...
var LoaderContainer = function (props) {
    ...
    return (jsx("div", __assign$1({ onClick: handleClick, className: className ? "".concat(finalClassName, " ").concat(className) : finalClassName, style: __assign$1(__assign$1({}, style), { height: finalSize, width: finalSize }) }, { children: children })));
};
...
var InfiniteLoader = function (props) {
    ...
    //text,
    size = props.size;
    return (jsx(LoaderContainer, __assign$1({ onClick: onClick, size: size }, { children: jsxs(Fragment, { children: [jsx(BasePreparingLoader, { size: size }), jsx("div", __assign$1({ style: {
                        position: "absolute",
                        width: "100%",
                        height: "100%",
                        display: "flex",
                    ...
                    } }, { children: onClick && (jsx(Clear, { color: "rgba(255,255,255,0.75)", size: 45, onClick: onClick })) }))] }) })));
};
...
var Layer = function (props) {
    ...
    if (visible)
        return (jsx("div", __assign$1({ className: finalClassName, style: style }, otherProps, { children: children })));
    else
        return jsx(Fragment, {});
};
...
var ImagePreview = function (props) {
    ...
    return (jsx(React.Fragment, { children: src && source && (finalHeight || finalWidth) && (jsx("img", { 
            //onLoad={handleLoad}
...
var Avatar = function (props) {
    ...
    if (!finalClassNameBorder)
        ...
        return (jsx(React.Fragment, { children: jsxs("div", __assign$1({ className: "fui-avatar-main-container".concat(variant === "circle" ? " circle" : "", " ").concat(finalClassNameBorder), style: style }, rest, { children: [isUloading ? (jsx(Layer, __assign$1({ visible: true }, { children: jsxs("div", __assign$1({ className: "fui-avatar-label" }, { children: [jsx(InfiniteLoader, { size: 50 }), uploadingLabel] })) }))) : src ? (jsx(ImagePreview, { className: "fui-avatar-image", src: src, alt: alt, onError: handleError, smartImgFit: smartImgFit })) : (jsx("div", __assign$1({ className: "fui-avatar-label" }, { children: emptyLabel }))), !readOnly && (jsxs(Fragment, { children: [!isUloading && (jsx("div", __assign$1({ className: "fui-avatar-label hide", onClick: handleClick }, { children: src ? changeLabel : emptyLabel }))), jsx(InputHidden, { multiple: false, accept: accept || "image/*", onChange: handleChangeInput, inputRef: inputRef })] }))] })) }));
    }
};
...
var FileCardRightActions = function (props) {
    ...
    if (visible)
        return (jsxs(Fragment, { children: [jsx("div", __assign$1({ className: "file-card-right-layer-header" }, { children: isActive && deleteIcon && (jsx(Clear, { className: darkMode ? "files-ui-file-icon dark-mode" : "files-ui-file-icon", color: darkMode ? "#121212" : "rgba(255,255,255,0.851)", onClick: onDelete, size: "small", colorFill: "transparent" })) })), jsx("div", __assign$1({ className: "file-card-right-layer-footer" }, { children: isActive && (jsxs(React.Fragment, { children: [imageIcon && (jsx(Visibility, { className: darkMode
                                    ? "files-ui-file-icon dark-mode"
                                    : "files-ui-file-icon", color: darkMode ? "#121212" : "rgba(255,255,255,0.851)", onClick: onSee, size: "small" })), videoIcon && (jsx(PlayIcon, { className: darkMode
                                    ? "files-ui-file-icon dark-mode"
                                    : "files-ui-file-icon", color: darkMode ? "#121212" : "rgba(255,255,255,0.851)", onClick: onWatch, size: "small" })), downloadIcon && (jsx(DownloadFile, { className: darkMode
                                    ? "files-ui-file-icon dark-mode"
                                    : "files-ui-file-icon", color: darkMode ? "#121212" : "rgba(255,255,255,0.851)", onClick: onDownload, size: "small" })), infoIcon && (jsx(InfoDisney, { className: darkMode
                                    ? "files-ui-file-icon dark-mode"
...
var FileCardInfoLayer = function (props) {
    ...
    return (jsxs("div", __assign$1({ className: "file-card-file-info" }, { children: [jsx(Cancel, { style: { margin: 0, right: 5, top: 0, position: "absolute" }, color: "rgba(255,255,255,0.8)", onClick: onCloseInfo, colorFill: "black" }), jsx("div", __assign$1({ className: "heading" }, { children: nameLabel })), jsx("div", __assign$1({ className: "label" }, { children: localName })), jsx("div", __assign$1({ className: "heading" }, { children: sizeLabel })), jsx("div", __assign$1({ className: "label" }, { children: sizeFormatted })), jsx("div", __assign$1({ className: "heading" }, { children: typeLabel })), jsx("div", __assign$1({ className: "label" }, { children: localType }))] })));
};
...
var AbortedStatus = function (props) {
    ...
    return (jsxs(React.Fragment, { children: [jsx(DoDisturb, { color: "#f44336", size: size || 65 }), jsxs("span", { children: [" ", FileItemStatusLocalizer.aborted] })] }));
};
...
var EmptyStatus = function (props) {
    ...
    var finalHeight = !height
        ...
        : typeof height === "number"
            ? "".concat(height, "px")
            : height;
    return (jsx(React.Fragment, { children: jsx("div", { style: { width: "100%", height: finalHeight } }) }));
};

var ErrorStatus = function (props) {
    var localization = props.localization, size = props.size;
    var FileItemStatusLocalizer = FileItemLocalizerSelector(localization).status;
    return (jsxs(React.Fragment, { children: [jsx(Clear, { color: "rgba(255,255,255,0.4)", style: {
                    backgroundColor: "rgba(244, 67, 54, 0.8)",
                    borderRadius: "50%",
                }, size: size || 65 }), jsxs("span", { children: [" ", FileItemStatusLocalizer.error] })] }));
};

var PreparingStatus = function (props) {
    var onCancel = props.onCancel, localization = props.localization, size = props.size;
    var FileItemStatusLocalizer = FileItemLocalizerSelector(localization).status;
    return (jsxs(React.Fragment, { children: [jsx(InfiniteLoader, { onClick: onCancel, size: size || 65 }), jsx("span", { children: FileItemStatusLocalizer.preparing })] }));
};

var SuccessStatus = function (props) {
    var localization = props.localization, size = props.size;
    var FileItemStatusLocalizer = FileItemLocalizerSelector(localization).status;
    return (jsxs(React.Fragment, { children: [jsx(CheckCircle, { color: "#4caf50", size: size || 65 }), jsxs("span", { children: [" ", FileItemStatusLocalizer.success] })] }));
};
...
var DynamicLoader = function (props) {
    ...
    if (percentage !== undefined)
        return (jsx(LoaderContainer, __assign$1({ size: size }, { children: jsxs(Fragment, { children: [jsxs("svg", __assign$1({ className: "dui_svg_circle_loader", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", width: "".concat(finalSize, "px"), height: "".concat(finalSize, "px"), style: finalStyle }, { children: [jsx("circle", { style: {
                                ...
                                id: "circle", ref: circleRef, fill: "none" }), !hidePerncentage && percentage !== undefined && (jsx("text", __assign$1({ className: "files-ui-text-dynamic-loader", x: "".concat(finalX), y: "".concat((finalX * 7) / 6) }, { children: "".concat(percentage.toFixed(0), " %") })))] })), onClick && (jsx("div", __assign$1({ style: {
                            position: "absolute",
                            width: "100%",
                            height: "100%",
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                        } }, { children: jsx(Clear, { color: "rgba(255,255,255,0.75)", size: 45, onClick: onClick }) })))] }) })));
    else {
        return jsx(Fragment, {});
    }
};
...
var UploadingStatus = function (props) {
    ...
    var FileItemStatusLocalizer = FileItemLocalizerSelector(localization).status;
    return (jsxs(React.Fragment, { children: [progress !== undefined ? (jsx(DynamicLoader, { size: 70, x: 35, y: 35, radius: 32, percentage: progress, width: 6, hidePerncentage: progress === undefined || onAbort !== undefined, onClick: onAbort })) : (jsx(InfiniteLoader, { onClick: onAbort, size: size || 70 })), jsxs("span", { children: [" ", FileItemStatusLocalizer.uploading] })] }));
};
...
var FileCardUploadLayer = function (props) {
    ...
    return (jsx("div", __assign$1({ className: "elevation-layer-container", ref: elevationContainerRef }, { children: jsx("div", __assign$1({ className: "elevation-list-card", ref: listContainerStoryRef }, { children: statusHistory.map(function (status, index) {
                switch (status) {
                    case "preparing":
                        return (jsx("div", __assign$1({ className: "elevation-item-card" }, { children: jsx(PreparingStatus, { onCancel: onCancel, localization: localization }) }), index + 1));
                    case "uploading":
                        return (jsx("div", __assign$1({ className: "elevation-item-card" }, { children: jsx(UploadingStatus, { onAbort: onAbort, progress: progress, localization: localization }) }), index + 1));
                    case "error":
                        return (jsx("div", __assign$1({ className: "elevation-item-card" }, { children: jsx(ErrorStatus, { size: 60, localization: localization }) }), index + 1));
                    case "success":
                        return (jsx("div", __assign$1({ className: "elevation-item-card" }, { children: jsx(SuccessStatus, { localization: localization }) }), index + 1));
                    case "aborted":
                        return (jsx("div", __assign$1({ className: "elevation-item-card" }, { children: jsx(AbortedStatus, { localization: localization }) }), index + 1));
                    default:
                        return (jsx("div", __assign$1({ className: "elevation-item-card" }, { children: jsx(EmptyStatus, {}) }), index + 1));
                }
            }) })) })));
};
...
var Tooltip = function (props) {
    ...
    return (jsx(React.Fragment, { children: open && message && statusClassName && (jsx("span", __assign$1({ className: "files-ui-tooltiptext ".concat(statusClassName) }, { children: message }))) }));
};
...
var DownloadHidden = function (props) {
    ...
    if (downloadUrl)
        return (jsx("a", __assign$1({ ref: anchorRef, target: "_blank", href: downloadUrl, download: fileName, hidden: true, rel: "noopener noreferrer", onClick: handleClick }, { children: "download_file" })));
    return jsx(Fragment, {});
};
...
var LayerContainer = function (props) {
    ...
    return (jsx("div", __assign$1({ className: finalClassName, style: style }, { children: children })));
};

var FileMosaicName = function (props) {
    var fileName = props.fileName;
    if (fileName)
        return jsx("span", { children: fileName });
    else {
        return jsx(Fragment, {});
    }
};
...
var FileMosaicUploadLayer = function (props) {
    ...
    //default phase
    return (jsx("div", __assign$1({ className: "elevation-layer-container", ref: elevationContainerRef }, { children: jsx("div", __assign$1({ className: "elevation-list", ref: listContainerStoryRef }, { children: statusHistory.map(function (status, index) {
                switch (status) {
                    case "preparing":
                        return (jsx("div", __assign$1({ className: "elevation-item" }, { children: jsx(PreparingStatus, { onCancel: onCancel, localization: localization }) }), index + 1));
                    case "uploading":
                        return (jsx("div", __assign$1({ className: "elevation-item" }, { children: jsx(UploadingStatus, { onAbort: onAbort, progress: progress, localization: localization }) }), index + 1));
                    case "error":
                        return (jsx("div", __assign$1({ className: "elevation-item" }, { children: jsx(ErrorStatus, { localization: localization }) }), index + 1));
                    case "success":
                        return (jsx("div", __assign$1({ className: "elevation-item" }, { children: jsx(SuccessStatus, { localization: localization }) }), index + 1));
                    case "aborted":
                        return (jsx("div", __assign$1({ className: "elevation-item" }, { children: jsx(AbortedStatus, { localization: localization }) }), index + 1));
                    default:
                        return (jsx("div", __assign$1({ className: "elevation-item" }, { children: jsx(EmptyStatus, {}) }), index + 1));
                }
            }) })) })));
};
...
var FileMosaicImageLayer = function (props) {
    ...
    //If blur is true
    if (isBlur) {
        return (jsx(React.Fragment, { children: !card && !error && imageSource && (jsx(ImagePreview, { src: localSource, alt: "blur ".concat(fileName), smartImgFit: false })) }));
    }
    return (jsx(React.Fragment, { children: jsx(ImagePreview, { onError: handleError, src: localSource, style: { borderRadius: "0px" }, alt: "preview ".concat(fileName), smartImgFit: smartImgFit }) }));
};
...
var FileMosaicStatus = function (props) {
    ...
    var FileItemStatusLocalizer = FileItemLocalizerSelector(localization).status;
    if (uploadStatus === "success") {
        return (jsxs("div", __assign$1({ className: "files-ui-file-item-status-container file-status-ok", style: style }, { children: [jsx(CloudDone, { color: "#4caf50", size: "small", className: "status-icon" }), FileItemStatusLocalizer.success] })));
    }
    if (uploadStatus === "error" || uploadStatus === "aborted") {
        return (jsxs("div", __assign$1({ className: "files-ui-file-item-status-container file-status-error", style: style }, { children: [jsx(UploadError, { color: "#f44336", size: "semi-medium", className: "status-icon" }), FileItemStatusLocalizer.error] })));
    }
    if (valid !== undefined && valid !== null) {
        if (valid) {
            return (jsxs("div", __assign$1({ className: "files-ui-file-item-status-container file-status-ok", style: style }, { children: [jsx(CheckCircle, { color: "#4caf50", size: "small", className: "status-icon" }), FileItemStatusLocalizer.valid] })));
        }
        else {
            return (jsxs("div", __assign$1({ className: "files-ui-file-item-status-container file-status-error", style: style }, { children: [jsx(DoDisturb, { color: "#f44336", size: "small", className: "status-icon" }), FileItemStatusLocalizer.denied] })));
        }
    }
    return jsx(Fragment, {});
};
...
var FileMosaicInfoLayer = function (props) {
    ...
    var FileItemLocalizer = FileItemLocalizerSelector(localization);
    var _a = FileItemLocalizer.fullInfoLayer, nameLabel = _a.name, sizeLabel = _a.size, typeLabel = _a.type;
    return (jsxs(React.Fragment, { children: [jsxs("div", __assign$1({ className: "files-ui-file-mosaic-info-layer-header" }, { children: [jsx(Cancel
                    //style={{ margin: 0, right: 0, top: 0 }}
                    , { 
                        //style={{ margin: 0, right: 0, top: 0 }}
                        color: "rgba(255,255,255,0.8)", onClick: onCloseInfo, colorFill: "black" }), jsx(FileMosaicStatus, { valid: valid, uploadStatus: uploadStatus, localization: localization })] })), jsx("div", __assign$1({ className: "heading" }, { children: nameLabel })), jsx("div", __assign$1({ className: "label" }, { children: localName })), jsx("div", __assign$1({ className: "heading" }, { children: sizeLabel })), jsx("div", __assign$1({ className: "label" }, { children: sizeFormatted })), jsx("div", __assign$1({ className: "heading" }, { children: typeLabel })), jsx("div", __assign$1({ className: "label" }, { children: localType }))] }));
};
...
var FileMosaicSize = function (props) {
    ...
    return (jsx(React.Fragment, { children: sizeFormatted && (jsx("div", __assign$1({ className: "filesui-file-item-size" }, { children: sizeFormatted }))) }));
};
...
var FileMosaicMainLayer = function (props) {
    ...
    return (jsxs(React.Fragment, { children: [jsx("div", __assign$1({ className: "file-mosaic-main-layer-header" }, { children: isActive && deleteIcon && (jsx(Clear, { className: darkMode ? "files-ui-file-icon dark-mode" : "files-ui-file-icon", color: darkMode ? "#121212" : "rgba(255,255,255,0.851)", onClick: onDelete, size: "small", colorFill: "transparent" })) })), jsxs("div", __assign$1({ className: "file-mosaic-main-layer-footer" }, { children: [jsxs("div", __assign$1({ className: "file-mosaic-footer-left" }, { children: [jsx(FileMosaicStatus, { valid: valid, uploadStatus: uploadStatus, localization: localization }), isActive && sizeFormatted && (jsx(FileMosaicSize, { sizeFormatted: sizeFormatted }))] })), jsx("div", __assign$1({ className: "file-mosaic-footer-right" }, { children: isActive && (jsxs(React.Fragment, { children: [imageIcon && (jsx(Visibility, { className: darkMode
                                        ? "files-ui-file-icon dark-mode"
                                        : "files-ui-file-icon", color: darkMode ? "#121212" : "rgba(255,255,255,0.851)", onClick: onSee, size: "small" })), videoIcon && (jsx(PlayIcon, { className: darkMode
                                        ? "files-ui-file-icon dark-mode"
                                        : "files-ui-file-icon", color: darkMode ? "#121212" : "rgba(255,255,255,0.851)", onClick: onWatch, size: "small" })), downloadIcon && (jsx(DownloadFile, { className: darkMode
...
var FileMosaic = function (props) {
    ...
    if (isReady)
        return (jsxs("div", __assign$1({ className: finalClassName, style: style, onClick: handleClick, onMouseEnter: handleOnHoverEnter, onMouseLeave: handleOnHoverLeave, onDoubleClick: handleDoubleClick, onContextMenu: handleRightClick }, { children: [jsxs(LayerContainer, __assign$1({ className: "files-ui-file-mosaic-icon-layer-container", style: style }, { children: [jsx(Layer, __assign$1({ className: "files-ui-file-mosaic-image-layer blur", visible: backgroundBlurImage }, { children: jsx(FileMosaicImageLayer, { imageSource: imageSource, url: url, fileName: localName, isBlur: true, smartImgFit: false }) })), jsx(Layer, __assign$1({ className: "files-ui-file-mosaic-image-layer", visible: true }, { children: jsx(FileMosaicImageLayer, { imageSource: imageSource, url: url, fileName: localName, isBlur: false, smartImgFit: smartImgFit }) })), jsx(Layer, __assign$1({ className: "files-ui-file-mosaic-main-layer", visible: !isUploading && !showInfo }, { children: jsx(FileMosaicMainLayer, { deleteIcon: onDelete !== undefined, onDelete: handleDelete, darkMode: darkMode, valid: valid, uploadStatus: uploadStatus, localization: localization, sizeFormatted: sizeFormatted, imageIcon: isImage && onSee !== undefined, onSee: function () { return onSee === null || onSee === void 0 ? void 0 : onSee(imageSource); }, videoIcon: isVideo && onWatch !== undefined, onWatch: function () { return onWatch === null || onWatch === void 0 ? void 0 : onWatch(videoSource); }, downloadIcon: onDownload !== undefined || downloadUrl !== undefined, onDownload: handleDownload, infoIcon: info !== undefined, onOpenInfo: handleOpenInfo, isActive: alwaysActive || hovering }) })), jsx(Layer, __assign$1({ className: "files-ui-file-mosaic-info-layer", visible: showInfo, onClick: handleClickUtil }, { children: jsx(FileMosaicInfoLayer, { onCloseInfo: handleCloseInfo, valid: valid, localization: localization, localName: localName, sizeFormatted: sizeFormatted, localType: localType }) })), jsx(Layer, __assign$1({ className: "files-ui-file-mosaic-upload-layer", visible: isUploading, onClick: handleClickUtil }, { children: jsx(FileMosaicUploadLayer, { uploadStatus: uploadStatus, progress: localProgress, onCancel: onCancel ? function () { return onCancel === null || onCancel === void 0 ? void 0 : onCancel(id); } : undefined, onAbort: onAbort ? handleAbort : undefined, localization: localization }) }))] })), jsx("div", __assign$1({ className: fileMosaicFileNameClassName }, { children: jsx(FileMosaicName, { fileName: localName }) })), jsx(Tooltip, { open: resultOnTooltip, uploadStatus: uploadStatus, valid: valid, errors: errors, uploadMessage: uploadMessage }), jsx(DownloadHidden, { fileName: localName, anchorRef: downloadRef, downloadUrl: downloadUrl })] })));
    return jsx(Fragment, {});
};
...
var FileCard = function (props) {
    ...
    if (isReady) {
        return (jsxs("div", __assign$1({ className: finalClassName, style: style, onClick: handleClick, onMouseEnter: handleOnHoverEnter, onMouseLeave: handleOnHoverLeave, onDoubleClick: handleDoubleClick, onContextMenu: handleRightClick }, { children: [jsxs(LayerContainer, __assign$1({ className: "files-ui-file-card-main-layer-container" }, { children: [jsx(Layer, __assign$1({ className: "file-card-main-layer", visible: true }, { children: jsxs("div", __assign$1({ className: "file-card-icon-plus-data" }, { children: [jsx("div", __assign$1({ className: "file-card-icon-container" }, { children: jsxs(LayerContainer, __assign$1({ className: "file-card-icon-layer" }, { children: [jsx(Layer, __assign$1({ className: "file-card-icon-layer blur", visible: backgroundBlurImage }, { children: jsx(FileMosaicImageLayer, { imageSource: imageSource, fileName: localName, url: url, isBlur: true, smartImgFit: false }) })), jsx(Layer, __assign$1({ className: "file-card-icon-layer", visible: true }, { children: jsx(FileMosaicImageLayer, { imageSource: imageSource, url: url, fileName: localName, isBlur: false, smartImgFit: smartImgFit }) })), jsx(Layer, __assign$1({ className: "file-card-status-layer", visible: true }, { children: jsx(FileMosaicStatus, { valid: valid, uploadStatus: uploadStatus, localization: localization }) }))] })) })), jsxs("div", __assign$1({ className: darkMode ? "file-card-data dark-mode" : "file-card-data" }, { children: [jsx("div", __assign$1({ className: "file-card-name" }, { children: localName })), jsx("div", __assign$1({ className: "file-card-size" }, { children: sizeFormatted })), jsx("div", __assign$1({ className: "file-card-size" }, { children: shrinkWord(localType) }))] }))] })) })), jsx(Layer, __assign$1({ className: "file-card-info-layer-container", visible: showInfo, onClick: handleClickUtil }, { children: jsx(FileCardInfoLayer, { onCloseInfo: handleCloseInfo, valid: valid, localization: localization, localName: localName, sizeFormatted: sizeFormatted, localType: localType }) })), jsx(Layer, __assign$1({ className: "file-card-upload-layer-container", visible: isUploading, onClick: handleClickUtil }, { children: jsx("div", __assign$1({ className: "files-ui-file-card-upload-layer" }, { children: jsx(FileCardUploadLayer, { uploadStatus: uploadStatus, progress: localProgress, onCancel: onCancel ? function () { return onCancel === null || onCancel === void 0 ? void 0 : onCancel(id); } : undefined, onAbort: onAbort ? handleAbort : undefined, localization: localization }) })) }))] })), jsx(FileCardRightActions, { deleteIcon: onDelete !== undefined, onDelete: handleDelete, darkMode: darkMode, imageIcon: isImage && onSee !== undefined, onSee: function () { return onSee === null || onSee === void 0 ? void 0 : onSee(imageSource); }, videoIcon: isVideo && onWatch !== undefined, onWatch: function () { return onWatch === null || onWatch === void 0 ? void 0 : onWatch(videoSource); }, downloadIcon: onDownload !== undefined || downloadUrl !== undefined, onDownload: handleDownload, infoIcon: info !== undefined, onOpenInfo: handleOpenInfo, isActive: alwaysActive || hovering, visible: !isUploading && !showInfo }), jsx(Tooltip, { open: resultOnTooltip, uploadStatus: uploadStatus, valid: valid, errors: errors, uploadMessage: uploadMessage }), jsx(DownloadHidden, { fileName: localName, anchorRef: downloadRef, downloadUrl: downloadUrl })] })));
    }
    return jsx(Fragment, {});
};
...
var FullScreen = function (props) {
    ...
    return (jsxs("div", __assign$1({ className: open ? "fui-fullscreen-container show-fs" : "fui-fullscreen-container", onClick: handleClose }, { children: [open && (jsx("div", __assign$1({ className: "fui-fullscreen-relative-container", onClick: handleClose }, { children: children }))), onClose && (jsx(Clear, { color: "rgba(255,255,255,0.8)", onClick: handleClose, colorFill: "transparent", className: "button-full-screen", size: "extra-large" }))] })));
};
...
var VideoPreview = function (props) {
    ...
    return (jsx(React.Fragment, { children: videoSrc && source && (jsxs("video", __assign$1({ onClick: function (evt) {
                evt.preventDefault();
            }, 
            ...
            src: source, 
            //width={"100%"}
            height: "100%", style: style }, others, { children: [jsx("source", { type: "video/webm" }), jsx("source", { type: "video/ogg" }), jsx("source", { type: "video/mp4" })] }))) }));
};

var FilesUiProvider = function (props) {
    var children = props.children, config = props.config;
    return (jsx(FilesUiContext.Provider, __assign$1({ value: config || {} }, { children: children })));
};
